...
import { FILTER_LISTS } from "./src/shared/filter-lists";
...
export default defineManifest({
  ...
  declarative_net_request: {
    rule_resources: [
      ...
      // Compiled upstream lists (generated by scripts/compile-lists.ts). They
      // exceed Chrome's guaranteed 30k static-rule minimum, so they start
      // disabled and src/background/index.ts enables them at install in
      // priority order while chrome.declarativeNetRequest's budget allows.
